...
os.environ["GEMINI_API_KEY"] = "AIzaSyAoebzpsto9Az8tEp_Bc3C-PkLrbIhCuIk"   
os.environ["MONGO_URI"] = "mongodb+srv://enmacondor_db_user:12344321@clustercaso06.azxhney.mongodb.net/?retryWrites=true&w=majority"
...
# ======================================================
# CONFIG GEMINI - VARIABLES DE ENTORNO
# ======================================================
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY")

if not GEMINI_API_KEY:
    st.error("❌ ERROR: Falta la variable de entorno GEMINI_API_KEY.")
    st.stop()
...
- SI el pedido NO está completo, responde de manera conversacional.
"""
...
# ======================================================
# CONFIG MONGO - VARIABLES DE ENTORNO
# ======================================================
MONGO_URI = os.getenv("MONGO_URI")

if not MONGO_URI:
    st.error("❌ ERROR: Falta la variable de entorno MONGO_URI.")
    st.stop()
